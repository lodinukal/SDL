...
#define VIEW_GPU_DESCRIPTOR_COUNT             MAX_STORAGE_TEXTURES_PER_STAGE + \
    MAX_STORAGE_TEXTURES_PER_STAGE + MAX_STORAGE_BUFFERS_PER_STAGE \
    + MAX_UNIFORM_BUFFERS_PER_STAGE
#define SAMPLER_GPU_DESCRIPTOR_COUNT          MAX_TEXTURE_SAMPLERS_PER_STAGE
#define VIEW_SAMPLER_STAGING_DESCRIPTOR_COUNT 10000
#define TARGET_STAGING_DESCRIPTOR_COUNT       10000
